      ...
      <div className="mt-8">
        ...
        <div className="flex flex-col gap-5 p-4">
          ...
          <div>
            ...
            <textarea
              className="resize-none w-full h-[120px] rounded-lg border-2 border-gray-200 outline-none focus-within:border-blue-500 transition hover:bg-[#f2f2f2] p-2"
          ...
          <button className="w-full px-3 py-2.5 rounded-md text-white flex items-center justify-center text-center bg-blue-500 transition hover:bg-blue-600 mt-2">
            Apply
          </button>
