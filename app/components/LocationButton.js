    ...
    <>
      <Menu as="div" className="sm:relative inline-block text-left z-10">
        <div>
          ...
          <Menu.Button
            className={`customShadow flex items-center gap-3 rounded-lg border-2 border-gray-200 overflow-hidden h-[45px] transition px-3 ${
              locationApplied === ""
          ...
          <Menu.Items className="absolute right-0 lg4:right-auto lg4:left-0 mt-2 origin-top-right divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none w-full sm:w-[400px]">
            <div className="">
              ...
              <div className="flex flex-col gap-2 px-3 pb-3 mt-2">
                <div className="text-[18px] text-[#1F2937] font-bold mb-[2px]">
                  Search
                </div>
                {/* input field starts */}
                ...
                <div className="text-[18px] text-[#1F2937] font-bold mt-2 mb-[2px]">
                  Most popular locations
                </div>
                <div className="flex items-center gap-3 flex-wrap whitespace-nowrap">
                  <button
                    onClick={() => {
                      setlocationNotApplied("London");
                    }}
                    className={`cursor-pointer px-2.5 py-1 text-[15px] rounded-full border-2 border-gray-200 transition ${
                      locationNotApplied === "London"
                        ? "bg-black text-white hover:bg-black hover:bg-opacity-70"
                        : "bg-white hover:bg-[#f2f2f2]"
                    }`}>
                    London
                  </button>
                  <button
                    onClick={() => {
                      setlocationNotApplied("New York");
                    }}
                    className={`cursor-pointer px-2.5 py-1 text-[15px] rounded-full border-2 border-gray-200 transition ${
                      locationNotApplied === "New York"
                        ? "bg-black text-white hover:bg-black hover:bg-opacity-70"
                        : "bg-white hover:bg-[#f2f2f2]te"
                    }`}>
                    New York
                  </button>
                  <button
                    onClick={() => {
                      setlocationNotApplied("Berlin");
                    }}
                    className={`cursor-pointer px-2.5 py-1 text-[15px] rounded-full border-2 border-gray-200 transition ${
                      locationNotApplied === "Berlin"
                        ? "bg-black text-white hover:bg-black hover:bg-opacity-70"
                        : "bg-white hover:bg-[#f2f2f2]"
                    }`}>
                    Berlin
